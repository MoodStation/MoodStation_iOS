...
final class UserInfoViewModel {
    ...
    private func makeSections() -> [Section] {
        return [
            ...
            .textField([.textField(.init(inset: UIEdgeInsets(top: 14, left: 24, bottom: 0, right: 0), placeholder: "닉네임", font: .body1R, text: userInfo?.name, isEnabled: false))]),
            ...
            .textField([
                .textField(.init(inset: UIEdgeInsets(top: 16, left: 24, bottom: 0, right: 0), placeholder: "사용할 비밀번호", font: .body1R, text: userInfo?.password, isEnabled: false, isSecureTextEntry: true)),
                .textField(.init(inset: UIEdgeInsets(top: 16, left: 24, bottom: 0, right: 0), placeholder: "비밀번호 재 확인", font: .body1R, text: userInfo?.password, isEnabled: false, isSecureTextEntry: true))]),
            .text([
